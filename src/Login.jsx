        ...
        <div className="card-body">
          ...
          <span className="fieldset-legend">Password</span>
            <label className="input validator">
              ...
              <input type="text" required placeholder="Password" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must be more than 8 characters, including number, lowercase letter, uppercase letter" value={password} onChange={(e)=>setpassworrd(e.target.password)}/>
            </label>
